...
Java_cn_bsd_learn_ndk_demo_GifInfoHandle_openFile(JNIEnv *env, jobject instance, jstring path_) {
...
JNIEXPORT jlong JNICALL
Java_cn_bsd_learn_ndk_demo_GifInfoHandle_renderFrame(JNIEnv *env, jobject instance,
...
Java_cn_bsd_learn_ndk_demo_GifInfoHandle_getWidth(JNIEnv *env, jobject instance, jlong gifInfoPtr) {
...
JNIEXPORT jint JNICALL
Java_cn_bsd_learn_ndk_demo_GifInfoHandle_getHeight(JNIEnv *env, jobject instance,
												   jlong gifInfoPtr) {
